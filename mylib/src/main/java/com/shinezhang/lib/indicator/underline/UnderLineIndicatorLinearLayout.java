...
public class UnderLineIndicatorLinearLayout extends LinearLayout implements IPageIndicatorGetter {
    ...
    public UnderLineIndicatorLinearLayout(Context context) {
        super(context);
        init();
    }

    public UnderLineIndicatorLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public UnderLineIndicatorLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
